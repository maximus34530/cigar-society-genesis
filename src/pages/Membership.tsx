  ...
  <Layout>
    <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 animate-fade-in">
        ...
        <p className="text-muted-foreground mt-4 text-lg">Private program — future scope</p>
    ...
    <section className="section-padding">
      <div className="container mx-auto">
        <SectionHeading title="Planned benefits" subtitle="Illustrative vision for a future La Sociedad program — not offered at launch." />
    ...
    <section className="section-padding bg-muted">
      <div className="container mx-auto text-center max-w-2xl">
        <SectionHeading title="Questions?" subtitle="Visit the lounge or reach out — we’d love to hear from you." />
