...
import humidorWebp from "@/assets/humidor.webp";
import tobacconistCertificateImg from "@/assets/tobacconist_certificate_enhanced.png";
import tobacconistCertificateWebp from "@/assets/tobacconist_certificate_enhanced.webp";
...
const About = () => {
  ...
  const { ref: storyRef, visible: storyVisible } = useFadeInOnScroll<HTMLElement>();
  ...
  return (
    <Layout>
      ...
      <section
        ref={sectionRef}
        className="relative flex min-h-[50vh] items-center justify-center overflow-hidden md:min-h-[55vh]"
      >
        <div
          ref={layerRef}
          className={cn(
            "absolute inset-0 z-0 h-[118%] w-full min-h-full -top-[9%] min-w-full overflow-hidden",
      ...
      <section className="section-padding bg-background">
        <div
          ref={storyRef}
          className={cn("fade-in-scroll-target container mx-auto max-w-6xl", storyVisible && "is-visible")}
        >
          <div className="grid items-start gap-12 md:grid-cols-2 md:gap-16">
            ...
            <div className="flex min-w-0 flex-col gap-8">
              <picture>
                <source srcSet={humidorWebp} type="image/webp" />
                <img
                  src={humidorImg}
              ...
              <picture>
                <source srcSet={tobacconistCertificateWebp} type="image/webp" />
                <img
